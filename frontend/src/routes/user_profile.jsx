    ...
    return (
        <VStack w='100%' alignItems='start' gap='40px'>
            <VStack gap='0'>
                ...
                <Text color='gray.600' fontSize='15px'>{ loading ? '-' : email}</Text>
            </VStack>
            <HStack gap='20px'>
                <VStack>
                    ...
                    <Text fontSize='18px' fontWeight="medium" textAlign="center">
                ...
                <VStack gap='20px'>``
                    ...
                    </HStack>
                    {
                        ...
                        :
                            ...
                            isOurProfile ?
                                <Button w='100%' onClick={editprofilebutton}>Edit Profile</Button>
                            :
